...
urlpatterns = [
    ...
    path("service-worker.js", fleet_views.pwa_service_worker, name="pwa_service_worker"),
    path("gestor/", fleet_views.dashboard, name="dashboard"),
    path("gestor/operacao/", fleet_views.operation_dashboard, name="operation_dashboard"),
    ...
    path("gestor/manutencoes/planos/novo/", fleet_views.maintenance_plan_create, name="maintenance_plan_create"),
    ...
    path("gestor/caixa/", fleet_views.cashflow_view, name="cashflow_view"),
    path("gestor/caixa/nova/", fleet_views.cash_entry_create, name="cash_entry_create"),
    path("gestor/caixa/<int:pk>/<slug:action>/", fleet_views.cash_entry_transition, name="cash_entry_transition"),
    path("trechos/", fleet_views.trip_list, name="trip_list"),
    path("gestor/trechos/planejar/", fleet_views.trip_plan_create, name="trip_plan_create"),
    path("trechos/iniciar/", fleet_views.trip_start, name="trip_start"),
    path("trechos/<int:pk>/iniciar-planejado/", fleet_views.trip_start_planned, name="trip_start_planned"),
    ...
    path("checklists/", fleet_views.checklist_list, name="checklist_list"),
    path("checklists/novo/", fleet_views.checklist_create, name="checklist_create"),
